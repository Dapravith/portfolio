        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 hover:bg-primary/20 transition-all duration-300 hover:scale-105"
              aria-label="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 hover:bg-blue-500/20 transition-all duration-300 hover:scale-105"
              aria-label="LinkedIn"
            >
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/10 hover:bg-red-500/20 transition-all duration-300 hover:scale-105"
              aria-label="Email"
            >
